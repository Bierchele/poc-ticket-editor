...
const TextOptionPanel = (props: any) => {
  ...
  const [textProps, setTextProps] = useState({
    ...
    borderColor: props.object.borderColor,
  });
  ...
  useEffect(() => {
    ...
    applyChange();
    props.canvas.getObjects().map(function (o: any) {
      return o;
    });
  }, [textProps]);
